...
using episerverBeginner.Models.ViewModels;

namespace episerverBeginner.Controllers
{
    /// <summary>
    ...
    {
        public ViewResult Index(PageDataBase currentPage)
        {
        ...
        /// </remarks>
        private static IPageViewModel<PageDataBase> CreateModel(PageDataBase page)
        {
            var type = typeof(PageViewModel<>).MakeGenericType(page.GetOriginalType());
            return Activator.CreateInstance(type, page) as IPageViewModel<PageDataBase>;
        }
    }
}

...
using episerverBeginner.Controllers;
using episerverBeginner.Models.Blocks;
using episerverBeginner.Models.Pages;
using EPiServer.Web;
using EPiServer.Web.Mvc;

namespace episerverBeginner.Business.Rendering
{
    ...
    public class TemplateCoordinator : IViewTemplateModelRegistrator
    {
        ...
        public void Register(TemplateModelCollection viewTemplateModelRegistrator)
        {
            ...
            {
                Tags = new[] { "JumbotronBlockBlue" },
                AvailableWithoutTag = false,
                Path = BlockPath("JumbotronBlockBlue.cshtml")
            });

            viewTemplateModelRegistrator.Add(typeof(PageDataBase), new TemplateModel
            {

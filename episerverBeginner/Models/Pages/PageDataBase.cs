...
using episerverBeginner.Business.Rendering;
using episerverBeginner.Models.Properties;
using EPiServer.Web;
...
namespace episerverBeginner.Models.Pages
{
    ...
    /// </summary>
    public abstract class PageDataBase : PageData, ICustomCssInContentArea
    {
        [Display(
            GroupName = "Metadata",
            Order = 100)]
